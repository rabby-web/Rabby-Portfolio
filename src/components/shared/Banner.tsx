      ...
      <div className="h-[56rem] w-full dark:bg-dark-bg-01  dark:bg-grid-white/[0.1] bg-grid-black/[0.1]">
        ...
        <div className="max-w-7xl mx-auto ">
          <div className="md:mt-20">
            {/* grid */}
            <div className="flex flex-col-reverse md:flex md:flex-row items-center py-4">
              <div className="flex-1 text-center md:text-left space-y-2">
                ...
                <div className="flex gap-2 justify-center items-center md:justify-start md:items-start mt-3">
                  <a
                    href="#_"
                    className="relative inline-flex items-center justify-center  p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 rounded-xl shadow-2xl group"
                  >

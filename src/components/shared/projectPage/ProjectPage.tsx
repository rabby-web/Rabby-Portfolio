        ...
        <div>
          <div className="flex-1">
            ...
            <p className="sm:text-base md:text-lg font-medium max-w-5xl mx-auto text-center md:text-left p-3 text-dark-01 dark:text-white">
              ...
              user experiences. <br />
              <br /> I am a passionate Web developer love for clean and
              efficient code. With a strong foundation in various programming
              frameworks, I am always eager to expand my knowledge and explore
              new technologies. With a keen eye for detail and a dedication to
              delivering high-quality Web solutions, I am driven to make a
              positive impact in the world of technology. Connect with me on
              GitHub to see my activity.
            </p>
          </div>
        </div>

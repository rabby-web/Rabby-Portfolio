      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-6 gap-3 mt-10">
        ...
        <div className="max-w-full m-3 p-6 bg-white border-b hover:dark:border-[#3CD1B8] border-gray-200 rounded-lg shadow dark:bg-[#0B1120] hover:dark:bg-gray-900 dark:border-gray-800 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            className="bi bi-globe2 w-10 h-10 text-purple-600  hover:dark:text-[#3CD1B8] mb-3"
            viewBox="0 0 16 16"
          >
        ...
        <div className="max-w-full m-3 p-6 bg-white border-b hover:dark:border-[#3CD1B8] border-gray-200 rounded-lg shadow dark:bg-[#0B1120] hover:dark:bg-gray-900 dark:border-gray-800 ">
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-activity w-10 h-10 text-fuchsia-600  hover:dark:text-[#3CD1B8] mb-3"
            viewBox="0 0 16 16"
          >
            <path
              fill-rule="evenodd"
